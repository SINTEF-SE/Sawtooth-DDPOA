...
# this block. These are different because async conesuses occassionally forks.
BLOCK_TO_CHECK_CONSENSUS = 52

time.sleep(1)

class TestDdpoaLiveness(unittest.TestCase):
    def test_ddpoa_liveness(self):
        """Test that a Sawtooth network publishes blocks and stays in consensus."""
        ...
        print("ALL GOOD! LIVENESS CHECK PASSED")
